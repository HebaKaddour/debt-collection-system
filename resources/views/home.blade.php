                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{ \App\Invoice::where('Value_Status', 2)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    @php
                                    $count_all= \App\Invoice::count();
                                    $count_invoices2 = \App\Invoice::where('Value_Status', 2)->count();
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        $count_all= \App\Invoice::count();
                                        $count_invoices1 = \App\Invoice::where('Value_Status', 1)->count();
